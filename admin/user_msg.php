...
if ($_REQUEST['act']=='list_all')
{
    ...
    $smarty->assign('telphone',     $msg_list['user_telphone']);
...
function msg_list()
{
    ...
    $sql = "SELECT f.msg_id, f.user_name, f.msg_title, f.msg_type, f.order_id, f.msg_status, f.msg_time, f.msg_area, f.user_telphone, COUNT(r.msg_id) AS reply " .
