...
INSERT INTO `ecs_users` VALUES ('1', '', 'admin', '271117b8983e34ab2d989070a9907f42', '', '', '0', '0000-00-00', '0.00', '0.00', '0', '0', '0', '0', '1482061483', '0000-00-00 00:00:00', '0.0.0.0', '2', '0', '0', '134', '0', '0', '0', null, null, null, null, null, '13804032787', '0', null, null, null, 'test', '贾永泽', '1', '1');
-- --------------------------------------------------------
...
drop table if EXISTS `ecs_seckill`;
...
-- ----------------------------
-- Table structure for ecs_scratch_award
-- ----------------------------
DROP TABLE IF EXISTS `ecs_scratch_award`;
CREATE TABLE `ecs_scratch_award` (
...
-- ----------------------------
-- Records of ecs_scratch_award
-- ----------------------------

-- ----------------------------
-- Table structure for ecs_scratch_fans
-- ----------------------------
DROP TABLE IF EXISTS `ecs_scratch_fans`;
CREATE TABLE `ecs_scratch_fans` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `fansID` int(11) DEFAULT '0',
...
-- ----------------------------
-- Table structure for ecs_scratch_reply
-- ----------------------------
DROP TABLE IF EXISTS `ecs_scratch_reply`;
CREATE TABLE `ecs_scratch_reply` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `starttime` varchar(50) DEFAULT '0',
