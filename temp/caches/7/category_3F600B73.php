    ...
    <div class="hl-filter">
        ...
        <div class="hl-value">
          <div class="hl-band-logos">
            <!--
             ...
             -->
            <ul>
                            <li style="margin:0 10px;"><a href="category.php?id=1&amp;brand=1&amp;price_min=0&amp;price_max=0" >
              <img src="data/brandlogo/1482662709844315574.png" width="107" height="50" alt="西门子(SIEMENS)" title="西门子(SIEMENS)">
                                </a></li>
                            <li style="margin:0 10px;"><a href="category.php?id=1&amp;brand=2&amp;price_min=0&amp;price_max=0" >
              <img src="data/brandlogo/1482653994478736960.png" width="107" height="50" alt="BOSCH" title="BOSCH">
                                </a></li>
      ...
      <div class="hl-filter-wrap">
        ...
        <div class="hl-value hl-clearfix">
          ...
          <ul class="hl-v-list hl-tc">
                            <li class=""><a class="hl-type-1" href="">双开门</a></li>
                                    <li class=""><a class="hl-type-1" href="">三开门</a></li>
                                    <li class=""><a class="hl-type-1" href="">多开门</a></li>
                                    <li class=""><a class="hl-type-1" href="">对开门</a></li>
                          </ul>
        </div>
      </div>
      <!--
        ...
        <div class="hl-value hl-clearfix">
          ...
          <ul class="hl-v-tab">
            ...
            <li>
                <a href="">制冷循环</a>
                <ul class="hl-son-list clearall">
                                                            <li><a href="">全自动节能智能循环</a></li>
                                                                                <li><a href="">半自动节能循环</a></li>
                                                                                <li><a href="">手控定时循环</a></li>
                                                        </ul>
            </li>
          </ul>
        </div>
  ...
  <div class="hl-center hl-goods-main hl-clearfix">
    ...
    <div class="hl-main-cont hl-fl">
      <ul class="hl-goods-list hl-clearfix">
            <li>
                <a class="hl-p-img hl-disp-b hl-tc" href="goods.php?id=3"><img src="images/201612/goods_img/3_G_1482676514480.jpg" alt=""></a>
                <div class="hl-price hl-mt10">
                  <strong class="hl-disp-b hl-ups hl-f24">￥3888元</strong>
                  <a class="hl-name hl-f14 hl-72" href="">抽油烟机</a>
                </div>
              </li>
            <li>
                <a class="hl-p-img hl-disp-b hl-tc" href="goods.php?id=2"><img src="images/201612/goods_img/2_G_1482658895488.jpg" alt=""></a>
                <div class="hl-price hl-mt10">
                  <strong class="hl-disp-b hl-ups hl-f24">￥5622元</strong>
                  <a class="hl-name hl-f14 hl-72" href="">bosch洗衣机</a>
                </div>
              </li>
            <li>
                ...
                <div class="hl-price hl-mt10">
                  ...
                  <a class="hl-name hl-f14 hl-72" href="">西门子（SIEMENS） BCD-610W(KA9...</a>
                </div>
              </li>
