...
<!--自定义-20161220-start-->
  <tr>
    <td class="label"><?php echo $this->_var['lang']['zhekou']; ?></td>
    <td><input name="zhekou" type="text" id="zhekou" value="<?php echo empty($this->_var['group_buy']['zhekou']) ? '8.5' : $this->_var['group_buy']['zhekou']; ?>" size="30"></td>
  </tr>
  <tr>
    <td class="label"><?php echo $this->_var['lang']['tuan_number']; ?></td>
    <td><input name="tuan_num" type="text" id="tuan_num" value="<?php echo empty($this->_var['group_buy']['tuan_num']) ? '1' : $this->_var['group_buy']['tuan_num']; ?>" size="30"></td>
  </tr>
<!--自定义-20161220-end-->
  <tr>
