    ...
    <div class="hl-product-intro hl-mb30 hl-clearfix">
      <div class="hl-preview hl-fl">
        <div id="preview" class="hl-spec-preview">
          <div class="hl-zoom">
            <img zoom-img="<?php echo $this->_var['goods']['goods_img']; ?>" src="<?php echo $this->_var['pictures']['0']['img_url']; ?>" width="478"/>
          </div>
        </div>
    ...
    <div class="hl-product-content hl-clearfix">
      <div class="hl-aside hl-fl">
        ...
        <ul class="hl-aside-list">
         <?php $_from = $this->_var['promotion_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_75348800_1482134180');if (count($_from)):
    foreach ($_from AS $this->_var['goods_0_75348800_1482134180']):
?>
          <li>
            <a class="hl-p-img hl-disp-b" href="goods.php?id=<?php echo $this->_var['goods_0_75348800_1482134180']['id']; ?>"><img src="<?php echo $this->_var['goods_0_75348800_1482134180']['goods_img']; ?>" alt=""></a>
            <div class="hl-price">
             价格暂定
              <strong class="hl-disp-b hl-ups hl-f24">
               <?php if ($this->_var['goods_0_75348800_1482134180']['promote_price'] != ""): ?>
      价格暂定
       <?php else: ?>
      价格暂定
      <?php endif; ?>
      </strong>
              <a class="hl-name hl-f14 hl-72" href="<?php echo $this->_var['goods_0_75348800_1482134180']['url']; ?>"><?php echo $this->_var['goods_0_75348800_1482134180']['short_style_name']; ?></a>
            </div>
          </li>
