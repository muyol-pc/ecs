  ...
  <div class="hl-center hl-slider-con hl-activity-slider">
    <div class="hl-activity-banner">
      <ul class="hl-activity-items">
        <?php $_from = $this->_var['index_ad_active']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'active');$this->_foreach['ad'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['ad']['total'] > 0):
    foreach ($_from AS $this->_var['active']):
        $this->_foreach['ad']['iteration']++;
?>
        <li><a href="<?php echo $this->_var['active']['url']; ?>" target="_blank"><img src="data/afficheimg/<?php echo $this->_var['active']['src']; ?>" style="display:block;width:100%;height:360px;" alt="" target="_blank"></a></li>
