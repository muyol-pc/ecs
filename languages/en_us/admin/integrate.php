 ...
 * Development Ltd.
 * Web site: http://www.honrisen.com
 * ----------------------------------------------------------------------------
...
$_LANG['need_not_setup'] = 'You needn\`t set wehn you use 商城 systerm';
$_LANG['neednot_sync'] ='You needn\'t synchronous operation, beacuse the 商城 member system is in use now.';
$_LANG['different_domain'] ='The integration object and 商城 of[with] your setup is not under same area.<Br/>you member\'s data that can share that system, but can\'t carry out to register in the meantime.';
